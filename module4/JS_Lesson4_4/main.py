...
class Paint(Frame):
    ...
    def print_some_word(self,label,word):
        label.configure(text=word)


    def setUI(self):

        self.parent.title("JUSTSCHOOL PAINT")  # Устанавливаем название окна
        ...
        color_lab = Label(self, text="Колір: ") # Создаем метку для кнопок изменения цвета кисти
        ...
        blue_btn = Button(self, text="Голубий", width=10,
        ...
        size_lab = Label(self, text="Розмір: ")
        ...
        exit_button= Button(self,text="X",bg="red",command=self.destroy)
...
#Этап І создание класса и заглушек функций
# from tkinter import *
